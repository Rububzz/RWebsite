...
function Message() {
  return (
    <div className="justify-center text-center bg-[url('/MessageBG.jpeg')] bg-cover bg-center h-dvh">
      <Navigationbar />
      <div className="text-yellow-300">
        <p>
          ...
          <br /> been 1 and a half years with you. It&#39;s really been an
          amazing time and I hope
          <br /> that we can have even more great times. I am sorta writing this
          before the final code even finishes
          <br /> so idk when imma give this to you (in Korea/Japan or in SG).
          <br />
        </p>
        <p>
